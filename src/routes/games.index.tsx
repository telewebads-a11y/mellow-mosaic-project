  ...
  return (
    <div className="relative min-h-screen">
      ...
      <header className="mx-auto flex max-w-md items-center justify-between px-4 pt-5">
        <button aria-label="Back" onClick={() => nav({ to: "/" })} className="rounded-full bg-white/80 p-2 shadow">
        ...
        <button aria-label="Home" onClick={() => nav({ to: "/" })} className="rounded-full bg-white/80 p-2 shadow">
