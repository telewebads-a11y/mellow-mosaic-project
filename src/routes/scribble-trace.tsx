...
const TILES: SubTile[] = [
  ...
  { title: "हिंदी वर्णमाला",   subtitle: "स्वर और व्यंजन",       icon: "अ आ", color: "tile-coral",  to: "/trace-varnamala", iconStyle: { color: "#fff", WebkitTextStroke: "2px #9a3412" } },
  { title: "हिंदी शब्द",        subtitle: "बिना मात्रा के शब्द",   icon: "कमल", color: "tile-mustard", to: "/trace-shabad", iconStyle: { color: "#fff", WebkitTextStroke: "1.5px #854d0e" } },
];
